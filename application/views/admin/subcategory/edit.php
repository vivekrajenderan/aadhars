                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="select2_single form-control" tabindex="-1" name="pk_cat_id" id="pk_cat_id">
                                        ...
                                        <?php foreach ($category_lists as $key => $cate_list) { ?>
                                            ...
                                            if ($get_sub_category_list[0]['fk_cat_id'] == $cate_list['pk_cat_id']) {
                                                echo "selected";
                                            }
                            ...
                            <div class="row"> 
                                <div class="form-group elVal">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">  
                                        ...
                                        <?php
                                        $display = "";                                        
                                        if ($get_sub_category_list[0]['channel_logo'] != '' && isset($get_sub_category_list[0]['channel_logo'])) {
                                            $display = "none";
                                            if (file_exists("./upload/channel/".$get_sub_category_list[0]['channel_logo'])) {
                                                $image_name = $get_sub_category_list[0]['channel_logo'];
                                            } else {
