                            ...
                            <tbody>
                                <?php foreach ($user_list as $key => $list) { ?>
                                    <tr>
                                        ...
                                        <td >   <a href="<?php echo base_url(); ?>admin/users/edit/<?php echo md5($list['pk_uid']); ?>" title="edit"><i class="fa fa-edit"></i></a> 
                                            &nbsp;&nbsp;&nbsp;<a title="delete" href="<?php echo base_url(); ?>admin/users/delete/<?php echo md5($list['pk_uid']); ?>" onClick="return confirm('Do u really want to delete User?');" > <i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
